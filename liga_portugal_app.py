...
url = 'https://github.com/ricardoandreom/Liga-Portugal-2021-22/raw/master/liga_pt.xlsx'

# Baixando o arquivo Excel como binário
response1 = requests.get(url, stream=True)
open('liga_pt.xlsx', 'wb').write(response1.content)

# Carregando o arquivo Excel como um objeto Workbook
wb = openpyxl.load_workbook('liga_pt.xlsx', data_only=True)
...
# URL da imagem no repositório GitHub
url1 = 'https://github.com/ricardoandreom/Liga-Portugal-2021-22/raw/master/ligapt.png'

# Baixando a imagem
response = requests.get(url1)
open('ligapt.png', 'wb').write(response.content)

# Abrindo a imagem
img1 = Image.open('ligapt.png')
...
url2 = 'https://github.com/ricardoandreom/Liga-Portugal-2021-22/raw/master/halfspace_analytics.png'

# Baixando a imagem
response2 = requests.get(url2)
open('halfspace_analytics.png', 'wb').write(response2.content)
